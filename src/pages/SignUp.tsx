...
const SignUp = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Store email for role selection page
    if (data?.user) {
    ...
    toast({
      ...
      description: "Proceed to configure your role and access level.",
    });
            ...
            <div className="backdrop-blur-2xl bg-black/40 border border-white/10 rounded-3xl p-6 sm:p-8 shadow-2xl">
              ...
              <div className="text-center space-y-2 mb-6">
                ...
                <p className="text-sm sm:text-base text-white/60">
                  Establish your credentials to access the platform.
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <Button
                  ...
                  className="w-full h-12 sm:h-14 rounded-xl text-sm sm:text-base font-semibold gradient-primary hover:opacity-90 text-white glow-primary transition-all duration-300 disabled:opacity-40 border-0 mt-2"
                >
                  {isLoading ? (
